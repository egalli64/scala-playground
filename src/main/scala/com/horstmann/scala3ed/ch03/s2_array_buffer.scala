...
3. Working with Arrays
 2. Variable-Length Arrays: Array Buffers - ArrayBuffer equivalent to Java ArrayList
 */
...
def s2_array_buffer(): Unit =
  ...
  println("An empty integer array buffer: " + b)
  ...
  println("After inserting a collection in position 2 - O(n): " + b)
  ...
  // using ArrayBuffer as an array builder
  val a = b.toArray
  b += 42
  println("The newly created array is: " + a.mkString(", "))
