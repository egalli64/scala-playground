...
def s3_readonly_property(): Unit =
  ...
  // the val properties, even if public, can't be changed
  class Message:
  ...
  val counter = Counter()
  // calling the getter generated by Scala
  println(counter.value)

  // won't compile, no parameter, no parentheses
//  println(counter.value())

  // won't compile, _value accessible only in Counter
//  println(counter._value)
