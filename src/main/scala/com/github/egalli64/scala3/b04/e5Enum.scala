...
import com.github.egalli64.scala3.b04.CrustType.Regular
import com.github.egalli64.scala3.b04.Topping.{BlackOlives, Pepperoni}
...
def enumerate(): Unit =
  /**
   * 1: assigning an enum to a variable
   */
